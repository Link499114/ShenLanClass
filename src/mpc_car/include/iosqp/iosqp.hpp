...
class IOSQP {
 public:
  ...
  inline c_int setMats(Eigen::SparseMatrix<double> &P,
    ...
    innerIdxP_ = innerIdxP;
    outerIdxP_ = outerIdxP;
    ...
    innerIdxA_ = innerIdxA;
    outerIdxA_ = outerIdxA;
    ...
    q_store_ = q.cast<c_float>();
    l_store_ = l.cast<c_float>();
    u_store_ = u.cast<c_float>();
    pData->q = q_store_.data();
    pData->l = l_store_.data();
    pData->u = u_store_.data();
 ...
 private:
  ...
  OSQPData *pData;
  Eigen::Matrix<c_float, -1, 1> q_store_, l_store_, u_store_;
  Eigen::Matrix<c_int, -1, 1> innerIdxP_, outerIdxP_, innerIdxA_, outerIdxA_;
};
